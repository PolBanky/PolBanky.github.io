...
//        window.alert("eval_c_to_f: function " + this.t_out);
    }, // function eval_c_to_f()
    
    // расчет площади круга в мм2
    eval_f_to_c: function () {   
        this.t_out = (this.t_in - 32.0) * 0.5555555; //
//        window.alert("eval_f_to_c: function " + this.t_out);
...
function Event_SelectChanged () {
   var ch = document.getElementById('c_or_f').value;
    ...
    {
        case 'c':
            document.getElementById('grad_input').title = "\u00B0C";            //  \u00B0 ГРАДУС в JS  !!!!!!
            document.getElementById('grad_input').placeholder = "Цельсий";      // окно ввода
            ...
            break;
        case 'f':
            document.getElementById('grad_input').title = "Градусов Фаренгейта";    // окно ввода
            document.getElementById('grad_input').placeholder = "Фаренгейт";        // окно ввода
...
c_f.t_in = document.getElementById('grad_input').value;
var ch = document.getElementById('c_or_f').value;
    ...
    switch (ch) // c_or_f - это select из index.html
    {
        case 'c':
            ...
            document.getElementById('grad_input').value = -273.15;
            c_f.t_in = document.getElementById('grad_input').value;
            }
            break;
        case 'f':
            ...
            document.getElementById('grad_input').value = -459.67;
            c_f.t_in = document.getElementById('grad_input').value;
            }
            break;
        default:
